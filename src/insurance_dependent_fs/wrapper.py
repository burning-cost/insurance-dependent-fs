...
from insurance_dependent_fs.model import DependentFreqSevNet, SharedTrunkConfig
from insurance_dependent_fs.training import DependentFSTrainer, TrainingConfig
from insurance_dependent_fs.data import FreqSevDataset, make_train_val_loaders
...
class DependentFSModel(BaseEstimator):
    ...
    def _forward_numpy(
        ...
        if self.use_explicit_gamma and n_claims_for_gamma is not None:
