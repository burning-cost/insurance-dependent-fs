"""Tests for diagnostics.py — DependentFSDiagnostics."""
import numpy as np
import pytest

from insurance_dependent_fs.benchmarks import make_dependent_claims, feature_cols
from insurance_dependent_fs.diagnostics import DependentFSDiagnostics
from insurance_dependent_fs.model import SharedTrunkConfig
