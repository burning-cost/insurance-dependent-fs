"""Tests for data.py — FreqSevDataset, prepare_features, make_train_val_loaders."""
import numpy as np
import pandas as pd
import pytest
import torch

from insurance_dependent_fs.data import FreqSevDataset, make_train_val_loaders, prepare_features
