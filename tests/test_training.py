"""Tests for training.py — JointLoss, DependentFSTrainer."""
import numpy as np
import pytest
import torch
...
from insurance_dependent_fs.training import DependentFSTrainer, JointLoss, TrainingConfig
from insurance_dependent_fs.data import FreqSevDataset
